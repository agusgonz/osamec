...
const ReseñasBanner: FC<ReseñasBannerProps> = ({}) => {
	return (
		<div className="relative">
			<div className="w-full h-full absolute bg-[url('/images/image-6.jpg')] bg-fixed bg-cover -z-10 brightness-50 "></div>

			<div className=" flex flex-col text-center items-center  px-6 gap-6 italic  text-white  py-12">
